                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="file" id="formFilePartner" name="logo"
                                onchange="previewImageLogo(event)">
                            @error('logo')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <div class="mt-3">
                                <img src="{{ asset('storage/') . '/' . $setting->logo }}" alt=""
                                    id="preview_logo" class="img-fluid" style="height: 300px">
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="formFilePartner" class="form-label">Hình ảnh</label>
                            <input type="file" id="formFilePartner" name="partner_image"
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <div class="mt-3">
                                <img src="{{ asset('storage/') . '/' . $setting->introduce_image }}" alt="" id="preview"
